    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-md-6">
                ...
                <form action="user_signup_data.php" method="post">
                    ...
                    <label>Password : </label> <input type="password" class="form-control" id="pass" name="password" placeholder="Enter Your Password" required /> <br>
                    <label>Confirm Password :</label> <input type="password" class="form-control" id="con_pass" name="con_password" placeholder="Enter Your Confirm Password" required /> <br>
